# CUDA_VISIBLE_DEVICES=1 python /bigdata/zlin/PanCancer_ICI/scripts/Spatial/Cell2location/cell2loc_NPC_GSE206245.py
import scanpy as sc
import numpy as np
...
# load reference data
# dir_datset='/bigdata/zlin/PanCancer_ICI/data/HNSC_Franken'
...
# load data
print('Loading data')
samples = ["ST10", "ST11", "ST12", "ST16", "ST17", "ST18", "ST19", "ST5",  "ST6",  "ST7",  "ST8",  "ST9" ]
dict_adata_vis = {
    sample: visium(path=f'/bigdata/zlin/PanCancer_ICI/data/GSE206245/GSE206245_RAW/{sample}', library_id=sample)
