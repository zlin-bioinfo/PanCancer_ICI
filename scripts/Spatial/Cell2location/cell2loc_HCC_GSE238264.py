# CUDA_VISIBLE_DEVICES=1 python /bigdata/zlin/PanCancer_ICI/scripts/Spatial/Cell2location/cell2loc_HCC_GSE238264.py
import scanpy as sc
import numpy as np
...
results_folder = '/bigdata/zlin/PanCancer_ICI/data/GSE238264_RAW/cell2loc_results'
# create paths and names to results folders for reference regression and cell2location models
ref_run_name = f'{results_folder}/reference_signatures'
# load reference data
dir_datset='/bigdata/zlin/PanCancer_ICI/data/HCC_Ma'
