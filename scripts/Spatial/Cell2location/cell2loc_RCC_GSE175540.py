# CUDA_VISIBLE_DEVICES=1 python /bigdata/zlin/PanCancer_ICI/scripts/Spatial/cell2loc_RCC_GSE175540.py
import scanpy as sc
import numpy as np
...
results_folder = '/bigdata/zlin/PanCancer_ICI/data/GSE175540/cell2loc_results'
# create paths and names to results folders for reference regression and cell2location models
ref_run_name = f'{results_folder}/reference_signatures'
# # load reference data
# dir_datset='/bigdata/zlin/PanCancer_ICI/data/RCC_Bi'
...
dict_adata_vis = {
    sample: sq.read.visium(path=f'/bigdata/zlin/PanCancer_ICI/data/GSE175540/GSE175540_RAW/{sample}', library_id=sample)
