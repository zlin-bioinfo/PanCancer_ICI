...
qsave(list_cd4, '/bigdata/zlin/Melanoma_meta/tables/score_cd4.qs')
list_cd4 <- qread('/bigdata/zlin/Melanoma_meta/tables/score_cd4.qs')
...
pdf('/bigdata/zlin/Melanoma_meta/figures/Functional_score_T/ht_func_cd4.pdf', height = 6, width = 8)
...
qsave(list_cd8, '/bigdata/zlin/Melanoma_meta/tables/score_cd8.qs')
list_cd8 <- qread('/bigdata/zlin/Melanoma_meta/tables/score_cd8.qs')
...
signatureType_row <- data.frame(Signature.type = c(
  ...
  rep("Apoptosis", length(Apoptosis))))
signatureType_row$Signature.type <- factor(signatureType_row$Signature.type, levels = c('Differentiation', 'Function','Metabolism','Apoptosis'))
pdf('/bigdata/zlin/Melanoma_meta/figures/Functional_score_T/ht_func_cd8.pdf', height = 6, width = 8)
Heatmap(FunctionScoreMatrix, name = 'Mean \n(z-score)',
...
qsave(list_mac, '/bigdata/zlin/Melanoma_meta/tables/score_mac.qs')
list_mac <- qread('/bigdata/zlin/Melanoma_meta/tables/score_mac.qs')
...
# ggsave('/bigdata/zlin/Melanoma_meta/figures/Functional_score_Mac/func_mac.pdf', height = 7, width = 5)

# Heatmap
pdf('/bigdata/zlin/Melanoma_meta/figures/Functional_score_Mac/ht_func_mac.pdf', height = 6, width = 6)
df_score |> 
...
funcscore_ht <- function(df, dataset, w = 4, h = 2){
  ...
  ht_median <- as.ggplot(pheatmap(FunctionScoreMatrix, main = unique(df$dataset), scale = 'row',
                                  ...
                                  fontsize = 8))
  p <- ht_median 
  ggsave(p, file = paste0("/bigdata/zlin/Melanoma_meta/figures/Functional_score_Mac/Macro_FunctionScore_heatmap_", unique(df$dataset), ".pdf"), width = w, height = h)
  return(p)
}
